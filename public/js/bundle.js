...
},{"./es6.array.iterator":"../../node_modules/core-js/modules/es6.array.iterator.js","./_object-keys":"../../node_modules/core-js/modules/_object-keys.js","./_redefine":"../../node_modules/core-js/modules/_redefine.js","./_global":"../../node_modules/core-js/modules/_global.js","./_hide":"../../node_modules/core-js/modules/_hide.js","./_iterators":"../../node_modules/core-js/modules/_iterators.js","./_wks":"../../node_modules/core-js/modules/_wks.js"}],"charts.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.shortenedLabels = exports.allLabels = exports.major = exports.individualChartData = exports.overallChartData = void 0;

/* eslint-disable */
var overallChartData;
exports.overallChartData = overallChartData;
var individualChartData; // Keeping Home page simple and to prevent errors as ChartJS is not defined in home.pug

exports.individualChartData = individualChartData;
...
if (document.querySelector("#forData")) {
  exports.overallChartData = overallChartData = JSON.parse(document.querySelector("#forData").getAttribute("data-overall")); // I need it for the mode in overallFeatures.

  exports.individualChartData = individualChartData = JSON.parse(document.querySelector("#forData").getAttribute("data-individual"));
} // Mode( Major or Minor Scale )


var modeFreq = function modeFreq(arr) {
  var major = 0;
...
var major = modeFreq(individualChartData);
exports.major = major;

var allLabelsHandler = function allLabelsHandler(array) {
  var allLabels = [];

  for (var i = 0; i < 7; i++) {
    var shortName = array[i].name.split("-")[0];
...
var allLabels = allLabelsHandler(individualChartData); // In mobile view, the labels mess up the chart as they are sometimes too long.

exports.allLabels = allLabels;
var shortenedLabels = [];
exports.shortenedLabels = shortenedLabels;

for (var i = 0; i < allLabels.length; i++) {
  var individualLabels = allLabels[i].split(" ");

  if (individualLabels.length > 2) {
    shortenedLabels[i] = individualLabels;
  }
}
},{}],"charts/overall/polar.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.polarConfig = void 0;
...
var dataOverallPolar = {
  ...
  datasets: [{
    ...
    data: [_charts.overallChartData.danceability, _charts.overallChartData.valence, _charts.overallChartData.energy],
    hoverOffset: 4
  }]
};
var polarConfig = {
...
exports.polarConfig = polarConfig;
},{"../../charts":"charts.js"}],"charts/overall/mode.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.modeChartConfig = void 0;
...
var dataMode = {
  ...
  datasets: [{
    ...
    borderColor: "rgb(230,230,230)",
    data: [_charts.major, _charts.individualChartData.length - _charts.major],
    hoverOffset: 4
  }]
};
var modeChartConfig = {
...
exports.modeChartConfig = modeChartConfig;
},{"../../charts":"charts.js"}],"charts/overall/tempo.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.tempoConfig = void 0;
...
var tempoData = {
  ...
  datasets: [{
    ...
    borderColor: "rgb(230,230,230)",
    data: [_charts.overallChartData.tempo],
    hoverOffset: 4
  }]
};
var tempoConfig = {
...
exports.tempoConfig = tempoConfig;
},{"../../charts":"charts.js"}],"charts/overall/overallStudio.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.overallStudioConfig = void 0;
...
var studioData = {
  ...
  datasets: [{
    ...
    data: [_charts.overallChartData.liveness, _charts.overallChartData.acousticness, _charts.overallChartData.speechiness, _charts.overallChartData.instrumentalness],
    hoverOffset: 4
  }]
};
var overallStudioConfig = {
  type: "line",
  data: studioData,
  options: {
    responsive: true,
...
exports.overallStudioConfig = overallStudioConfig;
},{"../../charts":"charts.js"}],"charts/comparison/line.js":[function(require,module,exports) {
"use strict";
...
/* eslint-disable */
var lineData = {
  labels: _charts.shortenedLabels,
  // borderColor: "rgb(230,230,230)",
  datasets: [{
    label: "Danceability",
    data: [_charts.individualChartData[0].danceability, _charts.individualChartData[1].danceability, _charts.individualChartData[2].danceability, _charts.individualChartData[3].danceability, _charts.individualChartData[4].danceability, _charts.individualChartData[5].danceability, _charts.individualChartData[6].danceability],
    backgroundColor: [randomColor({
      hue: "orange"
    })],
    borderColor: randomColor({
    ...
    label: "Valence",
    data: [_charts.individualChartData[0].valence, _charts.individualChartData[1].valence, _charts.individualChartData[2].valence, _charts.individualChartData[3].valence, _charts.individualChartData[4].valence, _charts.individualChartData[5].valence, _charts.individualChartData[6].valence],
    backgroundColor: [randomColor({
      hue: "purple"
    })],
    borderColor: randomColor({
    ...
    label: "Energy",
    data: [_charts.individualChartData[0].energy, _charts.individualChartData[1].energy, _charts.individualChartData[2].energy, _charts.individualChartData[3].energy, _charts.individualChartData[4].energy, _charts.individualChartData[5].energy, _charts.individualChartData[6].energy],
    backgroundColor: [randomColor({
      hue: "green"
    })],
    borderColor: randomColor({
...
},{"../../charts":"charts.js"}],"charts/comparison/area.js":[function(require,module,exports) {
"use strict";
...
var areaData = {
  ...
  datasets: [{
    label: "Speechiness",
    data: [_charts.individualChartData[0].speechiness, _charts.individualChartData[1].speechiness, _charts.individualChartData[2].speechiness, _charts.individualChartData[3].speechiness, _charts.individualChartData[4].speechiness, _charts.individualChartData[5].speechiness, _charts.individualChartData[6].speechiness],
    backgroundColor: [randomColor({
      hue: "blue"
    })],
    borderColor: randomColor({
    ...
    label: "Liveness",
    data: [_charts.individualChartData[0].liveness, _charts.individualChartData[1].liveness, _charts.individualChartData[2].liveness, _charts.individualChartData[3].liveness, _charts.individualChartData[4].liveness, _charts.individualChartData[5].liveness, _charts.individualChartData[6].liveness],
    backgroundColor: [randomColor({
      hue: "yellow"
    })],
    borderColor: randomColor({
...
},{"../../charts":"charts.js"}],"charts/comparison/radar.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.studioConfig = void 0;

var _charts = require("../../charts");

/* eslint-disable */
var studioData = {
  labels: _charts.allLabels,
  datasets: [{
    label: "Acousticness",
    data: [_charts.individualChartData[0].acousticness, _charts.individualChartData[1].acousticness, _charts.individualChartData[2].acousticness, _charts.individualChartData[3].acousticness, _charts.individualChartData[4].acousticness, _charts.individualChartData[5].acousticness, _charts.individualChartData[6].acousticness],
    backgroundColor: [randomColor({
      hue: "pink"
    })],
    borderColor: randomColor({
    ...
    data: [_charts.individualChartData[0].instrumentalness, _charts.individualChartData[1].instrumentalness, _charts.individualChartData[2].instrumentalness, _charts.individualChartData[3].instrumentalness, _charts.individualChartData[4].instrumentalness, _charts.individualChartData[5].instrumentalness, _charts.individualChartData[6].instrumentalness],
    backgroundColor: [randomColor({
      hue: "#c2ff85"
    })],
    borderColor: randomColor({
...
exports.studioConfig = studioConfig;
},{"../../charts":"charts.js"}],"../../node_modules/regenerator-runtime/runtime.js":[function(require,module,exports) {
var define;
/**
...
var _polar = require("./charts/overall/polar");

var _mode = require("./charts/overall/mode");

var _tempo = require("./charts/overall/tempo");

var _overallStudio = require("./charts/overall/overallStudio");

var _line = require("./charts/comparison/line");

var _area = require("./charts/comparison/area");

var _radar = require("./charts/comparison/radar");
...
if (logoutLink) {
  logoutLink.addEventListener("click", function () {
    ...
    setTimeout(function () {
      return spotifyLogoutWindow.close();
    }, 2000);
