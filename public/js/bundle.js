...
exports.shortenedLabels = exports.allLabels = exports.major = exports.dataLoop = exports.individualChartData = exports.overallChartData = void 0;
...
var dataLoop = function dataLoop(data, type) {
  var data_loop = [];
...
var major = modeFreq(individualChartData); // Handling Labels

exports.major = major;

var allLabelsHandler = function allLabelsHandler(array) {
  var allLabels = []; // To prevent overcrowding of labels.
...
for (var i = 0; i < allLabels.length; i++) {
  var arrayLabels = allLabels[i].split(" ");
...
var unique = allLabels.filter(onlyUnique);
window.addEventListener("DOMContentLoaded", function () {
  if (document.querySelector(".compare-heading")) {
    if (unique.length < 3) {
      var message = "Please listen to more unique and different songs for a better analysis here!";
...
/* eslint-disable */
var data_danceability = (0, _charts.dataLoop)(_charts.individualChartData, "danceability");
var data_valence = (0, _charts.dataLoop)(_charts.individualChartData, "valence");
var data_energy = (0, _charts.dataLoop)(_charts.individualChartData, "energy");
var lineData = {
...
/* eslint-disable */
var data_speechiness = (0, _charts.dataLoop)(_charts.individualChartData, "speechiness");
var data_liveness = (0, _charts.dataLoop)(_charts.individualChartData, "liveness");
var areaData = {
  labels: _charts.shortenedLabels,
  datasets: [{
    label: "Speechiness",
...
/* eslint-disable */
var labelLength = _charts.allLabels.length;
var data_acousticness_total = (0, _charts.dataLoop)(_charts.individualChartData, "acousticness");
var data_instrumentalness_total = (0, _charts.dataLoop)(_charts.individualChartData, "instrumentalness");
var data_acousticness = [];
var data_instrumentalness = [];
